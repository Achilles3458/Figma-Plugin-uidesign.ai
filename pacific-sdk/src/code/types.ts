import { extractWorldviewLineNode } from './worldview';
...
export function isValueConstant<T>(
  value: T | ConstantValue<T> | VariableValue<T>
): value is ConstantValue<T> {
  const ok =
...
export function isValueVariable<T>(
  value: T | ConstantValue<T> | VariableValue<T>
...
export function inspectValue<T>(
  value: T | ConstantValue<T> | VariableValue<T>
): InspectedValue<T> {
...
export type WorldviewSinglePaint =
  | WorldviewSolidPaint
  | WorldviewImagePaint
  | WorldviewGradientPaint;

export type WorldviewMixedPaint = {
  type: 'MIXED_PAINT';
  values: Array<
...
export type WorldviewPaint =
  | WorldviewSolidPaint
  | WorldviewImagePaint
  | WorldviewGradientPaint;

export type WorldviewEffect =
  | WorldviewDropShadowEffect
  | WorldviewInnerShadowEffect;
...
export type WorldviewContainerNode = {
  ...
  fill?:
    | WorldviewPaint
    | VariableValue<WorldviewPaint>
    | ConstantValue<WorldviewPaint>;

  // Stroke
  stroke?:
    | WorldviewSolidPaint
    | VariableValue<WorldviewSolidPaint>
    | ConstantValue<WorldviewSolidPaint>;
...
export type WorldviewComponentNode = {
  type: 'COMPONENT';
  id: string;
  name: string;
  x: number;
